...
\code{GNU_PROPERTY_X86_FEATURE_1_OR} and
\code{GNU_PROPERTY_X86_FEATURE_1_PERMISSIVE}:
...
\begin{description}
 \item[GNU_PROPERTY_X86_FEATURE_1_IBT] This indicates that all executable
   ...
   \code{GNU_PROPERTY_X86_FEATURE_1_OR}.
 ...
 \item[GNU_PROPERTY_X86_FEATURE_1_LAM_U48] This indicates that all
   ...
   This bit is ignored in \code{GNU_PROPERTY_X86_FEATURE_1_OR}.
 ...
 \item[GNU_PROPERTY_X86_FEATURE_1_WRSS] This indicates that some
   ...
   This bit is ignored in \code{GNU_PROPERTY_X86_FEATURE_1_AND}.
\end{description}
